export type { AnioLectivo, PeriodoAcademico, GradoOfertado, AsignaturaOfertada, PlanEstudio, Grado, Asignatura, Paralelo, OfertaAcademica, Asignatura as PlanAsignatura } from "./planificacion";
