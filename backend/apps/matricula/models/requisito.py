...
class Requisito(models.Model):
    archivo = models.FileField(upload_to='matricula/requisitos/', null=True, blank=True, validators=[FileExtensionValidator(['pdf'])])
    ...
    revisado_por = models.ForeignKey('actoresAcademicos.Cuenta', related_name='requisitos_revisados', on_delete=models.SET_NULL, null=True, blank=True)
