...
class AutoridadSerializer(UsuarioSerializer, serializers.ModelSerializer):
...
class SecretariaSerializer(UsuarioSerializer, serializers.ModelSerializer):
    direccion_domicilio = DireccionSerializer()
    cuenta = CuentaSerializer()
    class Meta:
        model = Secretaria
...
class DeceSerializer(UsuarioSerializer, serializers.ModelSerializer):
    direccion_domicilio = DireccionSerializer()
    cuenta = CuentaSerializer()
    class Meta:
        model = Dece
...
class AdministradorSerializer(UsuarioSerializer, serializers.ModelSerializer):
    direccion_domicilio = DireccionSerializer()
    cuenta = CuentaSerializer()
    class Meta:
        model = Administrador
