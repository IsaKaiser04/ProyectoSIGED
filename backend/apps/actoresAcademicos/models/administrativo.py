...
class Autoridad(Usuario):
    ...
    direccion_domicilio = models.ForeignKey('ubicacion.Direccion',on_delete=models.SET_NULL,null=True,blank=True,related_name='autoridad_direccion',verbose_name="Dirección Domiciliaria")
...
class Secretaria(Usuario):
    ...
    direccion_domicilio = models.ForeignKey('ubicacion.Direccion',on_delete=models.SET_NULL,null=True,blank=True,related_name='secretaria_direccion',verbose_name="Dirección Domiciliaria")
...
class Dece(Usuario):
    ...
    direccion_domicilio = models.ForeignKey('ubicacion.Direccion',on_delete=models.SET_NULL,null=True,blank=True,related_name='dece_direccion',verbose_name="Dirección Domiciliaria")
